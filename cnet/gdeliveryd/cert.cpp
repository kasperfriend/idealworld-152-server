...
Cert::Cert(unsigned char* cert, int len)
{
...
//
EVP_PKEY * Cert::GetPublicKey(const char *filename)
{
    BIO *in = NULL;
    X509 *ca = NULL;
...
//
EVP_PKEY * Cert::GetPrivateKey(const char *filename, const char *password)                                             
{                                                                                                                 
    BIO            *bp;                                                                                           
    EVP_PKEY      *pkey;                                                                                          
...
//
void Cert::GenerateRandNum(unsigned char *buf, int size)
{
	struct timeval tv;
