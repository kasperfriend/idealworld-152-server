...
private:
	bool ConditionCheck() 
	{
	   	return params.level>=20 && params.money>=0; 
	}
...
public:
	...
	{ 
	    ...
	    if( params.faction_name.size()>(17*2) || Matcher::GetInstance()->Match((char*)params.faction_name.begin(),params.faction_name.size())!=0)
		{
