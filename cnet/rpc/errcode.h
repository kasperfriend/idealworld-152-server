...
namespace GNET
{
	enum ErrCode {
		...
		// LoginCheck
		ERR_IP_LOCK		   = 26,
		ERR_MATRIX_ID_LOCK	   = 27, //您已连续三次使用密保卡登陆失败，为了您的账号安全，系统已将您的账号暂时封停。您可以在10分钟后再次尝试登录
		...
		ERR_LOGIN_LIMIT 	   = 135, //账号存在恶意登录的嫌疑，禁止登录，如果不是本人登录，请与客服联系。
		ERR_ACCOUNT_BE_MANAGED 	   = 136, //您的账号已被锁定，请稍后尝试登录。（被托管帐号自己登录时）
		ERR_PHONETOKEN_ID_LOCK 	   = 137, //您已连续三次输入令牌密码错误，为了您的账号安全，系统已将您的账号暂时封停。您可以在10分钟后再次尝试登录
		ERR_SSO_TICKET_EXPIRE		= 138,  //跳转时ticket过期，登陆失败
		ERR_SSO_TICKET_AID_NOT_MATCH	= 139,  //跳转时应用ID信息校验失败，登陆失败
		ERR_SSO_TICKET_ZONEID_NOT_MATCH	= 140,  //跳转时服务器ID校验失败，登陆失败
		ERR_KUAISU_REGIST_ACCOUNT	= 141,  //您是快速注册用户，账号信息尚不完善，存在严重安全隐患，请您及时登录完美通行证补填账号信息后再尝试登录。
