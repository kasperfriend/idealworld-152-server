...
//Added systems by apfilipp & joslian

#define VERSION 155

#define GUARD_SYSTEM //apfilipp
#define ANTI_TWIN_SYSTEM //apfilipp
#define DEBUG_PERMISSION_SYSTEM //apfilipp
#define ALWAYS_ONLINE_SYSTEM //joslian
