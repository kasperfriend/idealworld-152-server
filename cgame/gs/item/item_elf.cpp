...
bool elf_item::LevelUp(gactive_imp* imp)
{
	...
	if (ess.level > 104)
	{
		...
		char buffer[256] = {0x1f,0x04,0x3e,0x04,0x37,0x04,0x34,0x04,0x40,0x04,0x30,0x04,0x32,0x04,0x3b,0x04,0x4f,0x04,0x35,0x04,0x3c,0x04,0x2c,0x00,0x20,0x00,0x12,0x04,0x30,0x04,0x48,0x04,0x20,0x00,0x34,0x04,0x36,0x04,0x38,0x04,0x3d,0x04,0x3d,0x04,0x20,0x00,0x34,0x04,0x3e,0x04,0x41,0x04,0x42,0x04,0x38,0x04,0x33,0x04,0x20,0x00,0x3c,0x04,0x30,0x04,0x3a,0x04,0x41,0x04,0x38,0x04,0x3c,0x04,0x30,0x04,0x3b,0x04,0x4c,0x04,0x3d,0x04,0x3e,0x04,0x33,0x04,0x3e,0x04,0x20,0x00,0x43,0x04,0x40,0x04,0x3e,0x04,0x32,0x04,0x3d,0x04,0x4f,0x04,0x21,0x00};
		pImp->SelfChatMessage(buffer, 256, GMSV::CHAT_CHANNEL_SYSTEM);
...
bool elf_item::ChangeElfSecureStatus(int status, bool ischeck)//状态转化
{
	...
	case STATUS_SECURE:
		if(status == STATUS_TRANSFORM)
		{
			...
			ess.status_value = g_timer.get_systime() + 60;//7*24*3600
