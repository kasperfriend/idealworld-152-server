...
struct decompose_recipe_template
{
	...
	int require_level;
	int recipe_level;
	size_t decompose_fee;
	size_t decompose_time;
	size_t element_num;
	int element_id;
};
...
protected:      
	gmatter * CreateDynObject(const A3DVECTOR & pos,size_t index, world * pPlane,const entry_t & ent);
};
