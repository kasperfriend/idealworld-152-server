...
class service_npc : public gnpc_imp
{
	...
	static int _pepega_npc_wid;
public:
DECLARE_SUBSTANCE(service_npc);

public:							   	//   original: _serve_distance_unlimited(false)
	...
	// joslian
	static void SetPepegaNPC(int wid)
	{
		service_npc::_pepega_npc_wid = wid;
	}
	
	static int GetPepegaNPC()
	{
		return service_npc::_pepega_npc_wid;
	}
	
	static bool IsValidPepegaNPC()
	{
		return service_npc::_pepega_npc_wid != -1;
	}
	// joslian end
};
