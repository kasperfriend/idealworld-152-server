...
template <>
		...
		struct Make<INFO::player_info_00>
		{
			...
			inline static WRAPPER & From(WRAPPER & wrapper,int hp, struct basic_prop & bp, struct extend_prop & ep, char combat_state, int targetid) // todo ddr 1023
			{
				return wrapper <<  bp.level << combat_state << (unsigned char)bp.sec_level 
					<< hp << ep.max_hp << bp.mp << ep.max_mp << targetid;
			}
		...
		{
			template <typename WRAPPER>
				inline static WRAPPER & From(WRAPPER & wrapper,size_t vit,size_t eng,size_t str,size_t agi,size_t remain)
				{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper,gplayer* pPlayer,uint64_t mask_add,uint64_t mask_del,const void * buf, size_t size)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & FirstStep(WRAPPER & wrapper, size_t cost, size_t yinpiao, unsigned short all_amount)
			{
			...
			template <typename WRAPPER>
			inline static WRAPPER & FirstStep(WRAPPER & wrapper, size_t cost, size_t yinpiao, unsigned short all_amount,bool)
			{
				Make<single_data_header>::From(wrapper,PURCHASE_ITEM);
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper,const void * active,size_t asize, const void * finished, size_t fsize, const void * finished_time, size_t tsize, const void * finished_count, size_t csize, const void * storage_task, size_t ssize)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper,const XID & id,unsigned short *state_list,size_t state_count,int * param_list,size_t param_count)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, char is_usertrashbox, size_t amount)
			{
		...
		struct Make<INFO::market_goods>
		{
			...
			template <typename WRAPPER>
			inline static WRAPPER & SellItem(WRAPPER & wrapper, int type, int count, size_t price, const item_data & data)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, gobject * pObj, int market_id, size_t count)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, gobject * pObj, unsigned char market_crc,const char * name, size_t len)
			{
		...
		struct Make<CMD::self_open_market>
		{
			...
			template <typename WRAPPER>
			inline static WRAPPER & AddGoods(WRAPPER & wrapper, int type, unsigned short index, unsigned int count ,size_t price)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, const XID & self, const void * data, size_t size)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, int index, const void * data, size_t size)
			{
		...
		struct Make<CMD::player_pet_room>
		{
			...
			inline static WRAPPER & From(WRAPPER & wrapper, PET_DATA ** pData, size_t start, size_t end)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, size_t index)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, size_t index, float hp_factor)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, size_t index, float hp_factor, int cur_hp, float mp_factor, int cur_mp)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, const void * data, size_t size, const void* self_data, size_t self_size)
			{
		...
		struct Make<CMD::public_quest_ranks>
		{
			...
			template <typename WRAPPER>
			inline static WRAPPER & ClsRanksCount(WRAPPER & wrapper, size_t ranks_size)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, const XID & who, int type, const void * data, size_t size)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, const XID & who, int play_times,int action_last_time,int interval_time,size_t name_length,char* action_name)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, const XID & self, size_t money, unsigned char inv_size, const void * data, size_t size)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, int cur_force_id, size_t count, const void * data, size_t data_size)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, char data_ready, size_t count, const void * data, size_t data_size)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, int total_award_time, size_t count, const void * data, size_t data_size)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER &From(WRAPPER & wrapper,size_t index,int use_time)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper,int stime,int pet_id,size_t index,int r_attack,int r_defense,int r_hp,int r_atk_lvl,int r_def_lvl)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper,int stime,int pet_id,size_t index,int nature)
			{
		...
		struct Make<CMD::query_title>
		{
			...
			inline static WRAPPER & From(WRAPPER & wrapper, int roleid,int count,int ecount,
					const void * data, size_t data_size,const void* edata, size_t edata_size)
			{
		...
		struct Make<CMD::unique_data_notify>
		{
			...
			template <typename WRAPPER>
			inline static WRAPPER & Add(WRAPPER & wrapper, int key,int type,const void* p, size_t sz)
			{
				wrapper << key << type << sz;
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, size_t colloction_idx)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, int gain_times, size_t count)
			{
		...
		{
			template <typename WRAPPER>
			inline static WRAPPER & From(WRAPPER & wrapper, size_t attacker_count, size_t defender_count)
			{
