...
namespace S2C
{
	...
	enum 
	{
        ...
        ERR_CHANGE_GENDER_STATE,
        ERR_CHANGE_GENDER_GENDER,  // 195
        ERR_CHANGE_GENDER_CLS,
        ERR_CHANGE_GENDER_MARRIED,
        ERR_CHANGE_GENDER_FASHION,
        ERR_CHANGE_GENDER_PROFILE,
        ERR_CHANGE_GENDER_TASK,  // 200
	};
