...
{
	short physic_rune_level_min;
	short physic_rune_level_max;
	int physic_rune_enhance;
	
	short magic_rune_level_min;
	short magic_rune_level_max;
	int magic_rune_level;
	int magic_rune_enhance;
};
